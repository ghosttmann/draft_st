...
expName = 'builder_ai_dog_revised'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\st_ai_dog\\builder_ai_dog_revised_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    video = visual.MovieStim(
        win, name='video',
        filename='ai_dog.mp4', movieLib='ffpyplayer',
    ...
    while continueRoutine:
        ...
        if movie_devam_bilgi.status == NOT_STARTED and tThisFlip >= 320-frameTolerance:
            # keep track of start time/frame for later
        ...
        if video_cıkıs.status == NOT_STARTED and tThisFlip >= 320-frameTolerance:
            # keep track of start time/frame for later
